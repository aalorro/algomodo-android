        ...
        text = {
            Column(
                ...
                HelpSection("What is Algomodo?") {
                    ...
                    "Choose a family from the Generators tab, then pick a style to generate art. There are 177 generators across 15 families: Animation, Cellular, Flux, Fractals, Geometry, Graphs, Image, Noise, Physics, Pixel Art, Plotter, Procedural, Shader, Text, and Voronoi."
                }
                ...
                HelpSection("The Four Tabs") {
                    "Generators: Browse 15 families, select from 177 generators. Swipe left and right through the family tabs to reveal the generators in each family. Use the search bar to quickly filter by name or family.\n\n" +
                ...
                HelpSection("Shader Family (GPU)") {
                    "The Shader family contains 13 GPU-accelerated 3D ray-marched generators: Apollonian Spheres, Caustic Pool, Crystal Cavern, Geodesic, Glass Garden, Gray-Scott 3D, Heightfield Horizon, Infinite Lattice, Mandelbulb, Metaball Cluster 3D, SDF Sculpt, Tunnel Vision, and Twisted Forms.\n\n" +
                    "These run as fragment shaders on the GPU at interactive framerates. Several other families (Noise, Voronoi, and most escape-time Fractals) also use the same GPU pipeline transparently — saved presets and exports work identically to the CPU versions."
                }
                HelpSection("Presets") {
