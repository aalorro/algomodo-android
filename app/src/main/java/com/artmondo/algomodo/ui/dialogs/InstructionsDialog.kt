        ...
        text = {
            Column(
                ...
                HelpSection("What is Algomodo?") {
                    "Algomodo generates art using pure mathematics. It has 116 generators across 11 families: noise, fractals, cellular automata, geometry, Voronoi, graphs, plotter, text, image processing, animation, and procedural. All processing runs 100% locally on your device."
                }
                ...
                HelpSection("The Four Tabs") {
                    "Generators: Browse 11 families, select from 116 generators.\n\n" +
