 ...
 *
 * Port of web gravity-packing.ts (physics family). Supports 2D shapes
 * (square, rectangle, circle) and shaded 3D shapes (isometric cube,
 * radial-gradient sphere, cylinder with body gradient). Animation replays
 * the fall using a staggered quadratic ease-in and a settled breathing pulse.
 */
class PhysicsGravityPackingGenerator : Generator {

    override val id = "physics-gravity-packing"
